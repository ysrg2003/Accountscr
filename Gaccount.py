...
# COUNTRY_CODE = "175" #i.e, Australian country code, See country table in sms-activate. I often use Australian phone number, and it works almost always.
#
...
SELECTORS = {
    ...
    "next": [
        "//button[@class='VfPpkd-LgbsSe VfPpkd-LgbsSe-OWXEXe-k8QpJ VfPpkd-LgbsSe-OWXEXe-dgl2Hf nCP5yc AjY5Oe "
    ...
    "skip": [
        ...
        "//button[@class='VfPpkd-Jh9lGc']",
        "//button[@class='VfPpkd-RLmnJb']",
    ...
    "ID_selection": '//*[@id="view_container"]/div/div/div[2]/div/div[1]/div/form/span/section/div/div/div[1]/div[1]/div/span/div[1]/div/div[2]/div',
}
...
def setDriver():
    ...
    try:
        random_proxy = FreeProxy(timeout=1, https=True, ).get()
    ...
    # user_agent = "Mozilla/5.0 (Macintosh; Intel macOS X10_15_7) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/108.0.0.0 Safari/537.36" # Fixed agent
    # Please refer to this https://github.com/fake-useragent/fake-useragent
    user_agent = UserAgent(
        fallback="Mozilla/5.0 (Macintosh; Intel Mac OS X10_15_7) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/108.0.0.0 Safari/537.36").random
    print(user_agent)
    # Set Browser Option
...
def main():
    global first_names, last_names, user_infos, row, without_verification, phone_number_input, user_name, driver, user_info_file, id, gmail
    user_number = 0
    i = 0
    ...
    while True:
        try:
            # Check if the count reach to the maxim users.
            ...
            # if random_int ==  1:
            #
            # print('################ Create a google account article ################') driver.get(
            # 'https://support.google.com/accounts/answer/27441?hl=en') WebDriverWait(driver, WAIT).until(
            # EC.presence_of_element_located((By.XPATH,'//*[@id="hcfe-content"]/section/div/div[
            # 1]/article/section/div/div[1]/div/div[2]/a[1]'))).click() time.sleep(WAIT)
            if random_int == 2:
            ...
            # elif random_int == 4: driver.get('https://support.google.com/mail/answer/56256?hl=en') WebDriverWait(
            # driver, WAIT).until(EC.presence_of_element_located((By.XPATH,'//*[@id="hcfe-content"]/section/div/div[
            # 1]/article/section/div/div[1]/div/p[1]/a'))).click() time.sleep(WAIT)
            ...
            while username_try < REQUEST_MAX_TRY:
                ...
                first_name_tag = WebDriverWait(driver, WAIT * 2).until(
                    EC.presence_of_element_located((By.XPATH, SELECTORS['first_name'])))
                ...
                WebDriverWait(driver, WAIT).until(
                    EC.presence_of_element_located((By.XPATH, SELECTORS['acc_day']))).send_keys(birthday.split('/')[1])

                # Month
                select_acc_month = WebDriverWait(driver, WAIT).until(
                    EC.presence_of_element_located((By.XPATH, SELECTORS['acc_month'])))
                ...
                # Year
                WebDriverWait(driver, WAIT).until(
                    EC.presence_of_element_located((By.XPATH, SELECTORS['acc_year']))).send_keys(birthday.split('/')[2])
                ...
                time.sleep(WAIT * 2)
                WebDriverWait(driver, WAIT).until(
                    EC.presence_of_element_located((By.XPATH, '//*[@id="view_container"]/div/div/div[2]/div/div['
                                                              '1]/div/form/span/section/div/div/div[1]/div['
                                                              '1]/div/span/div[1]/div/div[2]/div'))).click()

                id = WebDriverWait(driver, WAIT).until(EC.presence_of_element_located((By.XPATH,
                                                                                       '/html/body/div[1]/div[1]/div['
                                                                                       '2]/div/div['
                                                                                       '2]/div/div/div[2]/div/div['
                                                                                       '1]/div/form/span/section/div'
                                                                                       '/div/div[1]/div['
                                                                                       '1]/div/span/div[1]/div/div['
                                                                                       '2]/div/div')))
                gmail = id.text
                print(gmail)
                # id.select_by_index('0')
                time.sleep(WAIT)
                ...
                print('################ Set Password ################')
                driver.implicitly_wait(time_to_wait=5)
                passwd_tag = WebDriverWait(driver, WAIT * 2).until(
                ...
                driver.implicitly_wait(time_to_wait=5)
                confirmwd_tag = WebDriverWait(driver, WAIT * 2).until(
                    EC.presence_of_element_located((By.XPATH, SELECTORS['confirm_password'])))
                # confirmwd_tag.clear()
                ...
                print('################ Click "Skip" Button for recovery email ################')
                driver.implicitly_wait(time_to_wait=5)
                for selector in SELECTORS['skip']:
                    try:
                        time.sleep(WAIT * 2)
                        WebDriverWait(driver, WAIT).until(EC.presence_of_element_located((By.XPATH, selector))).click()
                        break
                ...
                print('################ Click "Skip" Button for Phone Number ################')
                driver.implicitly_wait(time_to_wait=5)
                for selector in SELECTORS['skip']:
                    try:
                        time.sleep(WAIT * 2)
                ...
                print('################ Click "Next" Button For Gmail ID ################')
                driver.implicitly_wait(time_to_wait=5)
                for selector in SELECTORS['next']:
                    try:
                        time.sleep(WAIT * 2)
                ...
                f.write(first_name + "\t" + last_name + "\t" + password + "\t" + birthday + "\t" + gmail + "\n")
                f.close()
                driver.quit()

                # # set username print('################ Set User Name ################') if user_name_manual == "":
                # rand_5_digit_num = random.randint(10000,99999) user_name = first_name +"."+ last_name user_name =
                # user_name.lower() + str(rand_5_digit_num) else: user_name = user_name_manual user_name_tag =
                # WebDriverWait(driver, WAIT).until(EC.presence_of_element_located((By.XPATH, SELECTORS[
                # 'username']))) user_name_tag.clear() print(user_name) time.sleep(WAIT/2) user_name_tag.send_keys(
                # user_name)
                #
                #
                # print('################ Check Username Validation ################') try: WebDriverWait(driver,
                # WAIT).until(EC.presence_of_element_located((By.XPATH, SELECTORS['username_warning'])))
                # user_name_manual = "" print("Invalid") username_try = username_try + 1 continue except: print(
                # "Valid") pass
            # print('################ Check Phone Verification ################') without_verification = False try:
            # WebDriverWait(driver, WAIT).until(EC.presence_of_element_located((By.XPATH, SELECTORS['acc_day'])))
            # without_verification = True print("No. It doesn't require.") break except: print("Yes. It requires")
            # pass print('################ Input Phone Number ################') try: phone_number_input =
            # WebDriverWait(driver, WAIT*3).until(EC.presence_of_element_located((By.XPATH, SELECTORS[
            # 'phone_number']))) time.sleep(WAIT) break except: username_try = username_try + 1 number = ""
            # activationId = "" count = 0 if without_verification == False: print('################ Get Phone Number
            # from SMS_Activate ################') while(count < REQUEST_MAX_TRY): res = requests.get(
            # url=sms_activate_url,params = phone_request_params) data = res.text print(data) if "ACCESS_NUMBER" in
            # data: activationId = data.split(':')[1] number = data.split(':')[2]
            #
            # number = '+'+ number print(number) break if "NO_BALANCE" in data: print("Check your Balance in
            # sms-activate.") exit() count = count+1 time.sleep(WAIT) if number == '': print("################ Cannot
            # get phone number: ", REQUEST_MAX_TRY, " times retrial. ################") raise Exception("Go to next
            # account.")
            #
            #     phone_number_input.send_keys(number)
            #
            # #click next button print('################ Click "Next" Button ################') for selector in
            # SELECTORS['next']: try: WebDriverWait(driver, WAIT).until(EC.presence_of_element_located((By.XPATH,
            # selector))).click() break except: pass
            #
            ...
            #
            # print('################ Verify Phone Code ################') WebDriverWait(driver, WAIT).until(
            # EC.presence_of_element_located((By.XPATH, SELECTORS['code']))).send_keys(code)
            #
            # #click next button print('################ Click "Verify" Button ################') for selector in
            # SELECTORS['next']: try: WebDriverWait(driver, WAIT).until(EC.presence_of_element_located((By.XPATH,
            # selector))).click() break except: pass
            #
            # time.sleep(WAIT*2) print('################ Clear Account Phone Number ################') #
            # WebDriverWait(driver, WAIT).until(EC.presence_of_element_located((By.XPATH, SELECTORS[
            # 'acc_phone_number']))).clear()

            driver.quit()

            # --------------------------  Instagram Bot Code below ----------#

            print("###################  Instagram Bot  ##################")

            print("######### Opening Browser for instagram  ###########")

            driver.get("https://www.instagram.com/accounts/emailsignup/")
            driver.implicitly_wait(time_to_wait=10)
            time.sleep(8)
            try:
                cookie = WebDriverWait(driver, WAIT).until(EC.element_to_be_clickable((By.XPATH,
            ...
            full_name = fullname_field.send_keys(first_name + "" + last_name)
            print(full_name)

            driver.implicitly_wait(time_to_wait=5)
            user_name_field = driver.find_element(By.NAME,'username')
            user_name_field.clear()
            user_name = user_name_field.send_keys(last_name + first_name)
            print(user_name)
